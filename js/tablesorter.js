	...
	$.extend({
		...
		tablesorter: new function() {
			...
			ts.defaults = {
				...
				cssIconNone      : 'http://beta.paladder.com/include/image/sort.gif', // class name added to the icon when there is no column sort
				cssIconAsc       : 'http://beta.paladder.com/include/image/asc.gif', // class name added to the icon when the column has an ascending sort
				cssIconDesc      : 'http://beta.paladder.com/include/image/desc.gif', // class name added to the icon when the column has a descending sort
